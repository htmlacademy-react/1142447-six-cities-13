...

  {
    ...
    reviews: [
      ...
      },
      {
        ...
        comment:
        'Home is amazing. It"s like staying in a museum. The rooms, furnishings and artworks are incredible. The views of My Vesuvius', date: '2023-07-04T21:00:00.388Z',
        rating: 4,
        user: {
          name: 'Emely',
          avatarUrl: 'https://13.design.pages.academy/static/avatar/9.jpg',
